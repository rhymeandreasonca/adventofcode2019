...
class CalculationException(Exception):
	""" Raised when the FuelCalculator encounters a fatal exception. """
	pass

class FuelCalculator:
	"""A simple tool for calculating the total amount of fuel required to launch a group of modules based on their individual masses and the recursive mass of the fuel required by the initial launch.
